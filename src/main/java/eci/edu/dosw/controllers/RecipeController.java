...
public class RecipeController {
    ...
    @Operation(summary = "Get recipes by chef type", description = "Retrieves all recipes for a specific chef type (PARTICIPANT, JURY, or VIEWER)")
    ...
    @Operation(summary = "Get recipes by ingredient", description = "Searches for recipes containing a specific ingredient")
    ...
    @Operation(summary = "Get recipes by season", description = "Searches for recipes by season (only for PARTICIPANT chefs)")
    ...
    public ResponseEntity<Recipe> updateRecipe(
            ...
            @RequestBody UpdateRecipeDTO recipeUpdateRequest) {
