...
class RecipeServiceTest {
    ...
    @BeforeEach
    void setUp() {
        testRecipe = new ParticipantRecipe(
                "1",
                "Test Recipe",
                "Test Chef",
        ...
        testUpdateDTO = new UpdateRecipeDTO(
                "Updated Recipe",
    ...
    void getRecipesByChefType_NotFound() {
        ...
        assertThrows(BussinessException.class, () ->
                recipeService.getRecipesByChefType(ChefType.PARTICIPANT));
    }
    ...
    void createRecipe_InvalidChefType() {
        RecipeDTO invalidDTO = new RecipeDTO(
    ...
    void updateRecipe_NotFound() {
        ...
        assertThrows(BussinessException.class, () ->
                recipeService.updateRecipe("Nonexistent", testUpdateDTO));
    }
    ...
    void createRecipe_ParticipantWithSeason_Success() {
        RecipeDTO participantDTO = new RecipeDTO(
                "Participant Recipe",
                Arrays.asList("ing1", "ing2"),
                Arrays.asList("step1", "step2"),
                "Participant Chef",
        ...
        ParticipantRecipe participantRecipe = new ParticipantRecipe(
                "part-1",
                "Participant Recipe",
                "Participant Chef",
                ChefType.PARTICIPANT,
    ...
    void createRecipe_JuryWithoutSeason_Success() {
        RecipeDTO juryDTO = new RecipeDTO(
                "Jury Recipe",
                Arrays.asList("ing1", "ing2"),
                Arrays.asList("step1", "step2"),
                "Jury Chef",
        ...
        JuryRecipe juryRecipe = new JuryRecipe(
                "jury-1",
                "Jury Recipe",
                "Jury Chef",
                ChefType.JURY,
    ...
    void createRecipe_ViewerWithoutSeason_Success() {
        RecipeDTO viewerDTO = new RecipeDTO(
                "Viewer Recipe",
                Arrays.asList("ing1", "ing2"),
                Arrays.asList("step1", "step2"),
                "Viewer Chef",
    ...
    void updateRecipe_PartialUpdate_Success() {
        UpdateRecipeDTO partialUpdate = new UpdateRecipeDTO(
                "Updated Title",
                null,
                null,
                "Updated Chef"
    ...
    void updateRecipe_OnlyIngredients_Success() {
        ...
        UpdateRecipeDTO ingredientsUpdate = new UpdateRecipeDTO(
                null,
                newIngredients,
                null,
                null
    ...
    void getRecipesByIngredient_EmptyResult_ThrowsException() {
        when(recipeRepository.findByRecipesByIngredient("nonexistent"))
                .thenReturn(null);

        assertThrows(BussinessException.class, () ->
                recipeService.getRecipesByIngredient("nonexistent"));
    }

    @Test
    void getRecipesBySeason_EmptyResult_ThrowsException() {
        when(recipeRepository.findByRecipesBySeason("Winter"))
                .thenReturn(null);

        assertThrows(BussinessException.class, () ->
                recipeService.getRecipesBySeason("Winter"));
    }
    ...
    void createRecipe_WithEmptyCollections_Success() {
        RecipeDTO emptyCollectionsDTO = new RecipeDTO(
    ...
    void createRecipe_WithSpecialCharactersInTitle_Success() {
        RecipeDTO specialTitleDTO = new RecipeDTO(
    ...
    void createRecipe_WithVeryLongStrings_Success() {
        ...
        List<String> longIngredients = Arrays.asList(
                longString,
                "B".repeat(500)
        );
        List<String> longInstructions = Arrays.asList(
                "Step 1: " + longString,
                "Step 2: " + "C".repeat(800)
        );

        RecipeDTO longStringsDTO = new RecipeDTO(
                longString,
                longIngredients,
                longInstructions,
                "Chef " + longString,
    ...
    void getRecipesByIngredient_CaseInsensitive_Success() {
        when(recipeRepository.findByRecipesByIngredient("ING1"))
                .thenReturn(Arrays.asList(testRecipe));
    ...
    void createRecipe_WithNullChefName_Success() {
        RecipeDTO nullChefNameDTO = new RecipeDTO(
                "Test Recipe",
                Arrays.asList("ing1", "ing2"),
                Arrays.asList("step1", "step2"),
                null,
    ...
    void createRecipe_WithWhitespaceOnlyStrings_ThrowsException() {
        RecipeDTO whitespaceDTO = new RecipeDTO(
                "   ",
                Arrays.asList("ing1"),
                Arrays.asList("step1"),
                "Chef",
    ...
    void createRecipe_ParticipantWithoutSeason_ThrowsException() {
        RecipeDTO participantNoSeasonDTO = new RecipeDTO(
                "Participant Recipe",
                Arrays.asList("ing1", "ing2"),
                Arrays.asList("step1", "step2"),
                "Participant Chef",
        ...
        assertThrows(BussinessException.class, () -> recipeService.createRecipe(participantNoSeasonDTO));
    }

    @Test
    void createRecipe_ParticipantWithEmptySeason_ThrowsException() {
        RecipeDTO participantEmptySeasonDTO = new RecipeDTO(
                "Participant Recipe",
                Arrays.asList("ing1", "ing2"),
                Arrays.asList("step1", "step2"),
                "Participant Chef",
        ...
        assertThrows(BussinessException.class, () -> recipeService.createRecipe(participantEmptySeasonDTO));
    }

    @Test
    void updateRecipe_WithEmptyStrings_HandledCorrectly() {
        UpdateRecipeDTO emptyStringsDTO = new UpdateRecipeDTO(
                "",
                Arrays.asList(),
                Arrays.asList(),
                ""
