...
class RecipeControllerTest {
    ...
    void setUp() {
        testRecipe = new Recipe() {
            ...
            @Override
            public String getRecipeTitle() { return "Test Recipe"; }
            @Override
            public ChefType getChefType() { return ChefType.PARTICIPANT; }
        };
    ...
    void getRecipesByIngredient_Success() {
        when(recipeService.getRecipesByIngredient("ing1"))
                .thenReturn(Arrays.asList(testRecipe));

        ResponseEntity<List<Recipe>> response =
                recipeController.getRecipesByIngredient("ing1");
    ...
    void getRecipesBySeason_Success() {
        when(recipeService.getRecipesBySeason("Summer"))
                .thenReturn(Arrays.asList(testRecipe));

        ResponseEntity<List<Recipe>> response =
                recipeController.getRecipesBySeason("Summer");
    ...
    void updateRecipe_Success() {
        ...
        ResponseEntity<Recipe> response =
                recipeController.updateRecipe("Test Recipe", testUpdateDTO);
    ...
    void getRecipesByChefType_EmptyList_Success() {
        when(recipeService.getRecipesByChefType(ChefType.VIEWER))
                .thenReturn(Arrays.asList());

        ResponseEntity<List<Recipe>> response =
                recipeController.getRecipesByChefType(ChefType.VIEWER);
    ...
    void getRecipeById_ServiceThrowsException_PropagatesException() {
        ...
        assertThrows(BussinessException.class, () ->
                recipeController.getRecipeById("999"));
    }
    ...
    void createRecipe_ServiceThrowsException_PropagatesException() {
        ...
        assertThrows(BussinessException.class, () ->
                recipeController.createRecipe(testRecipeDTO));
    }
    ...
    void updateRecipe_PartialUpdate_Success() {
        ...
        ResponseEntity<Recipe> response =
                recipeController.updateRecipe("Test Recipe", partialUpdate);
    ...
    void deleteRecipe_ServiceThrowsException_PropagatesException() {
        ...
        assertThrows(BussinessException.class, () ->
                recipeController.deleteRecipe("Nonexistent"));
    }

    @Test
    void getRecipesBySeason_ParticipantRecipes_Success() {
        ParticipantRecipe seasonalRecipe = new ParticipantRecipe(
                "2",
                "Summer Salad",
                "Summer Chef",
                ChefType.PARTICIPANT,
        ...
        when(recipeService.getRecipesBySeason("Summer"))
                .thenReturn(Arrays.asList(seasonalRecipe));
    ...
    void getRecipesByIngredient_MultipleRecipes_Success() {
        ...
        Recipe recipe2 = new ViewerRecipe(
                "4",
                "Bacon Sandwich",
                "Viewer Chef",
                ChefType.VIEWER,
        ...
        when(recipeService.getRecipesByIngredient("bacon"))
                .thenReturn(Arrays.asList(recipe1, recipe2));

        ResponseEntity<List<Recipe>> response =
                recipeController.getRecipesByIngredient("bacon");
